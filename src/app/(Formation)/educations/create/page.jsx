        ...
        <div className="justify-center items-center" >
          ...
          <div className="p-4 sm:p-7 flex flex-col bg-gray-100 rounded-2xl shadow-lg ">
            <div className="text-center">
              <h1 className="block text-3xl font-bold text-primary-600 ">nouvelle education</h1>
            </div>
            <div className="mt-5">
              <div className="grid grid-cols-1 gap-4">
                ...
                <div>
                  <label className=" font-bold inline-flex gap-x-2"  >
                    ...
                    <input type="file" {...register("data.img")} onChange={(event) => { setImageUpload(event.target.files[0]);
