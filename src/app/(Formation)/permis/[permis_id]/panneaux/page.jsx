...
export default function PanneauxPage({ params }) {
    return (
        <>
            ...
            <div className="flex items-center justify-between mb-4 md:mb-6 lg:mb-8">
                ...
                <Link href={`/permis/${params.permisid}/panneaux/addPanneaux`}>
                    <button
                            ...
                            <tbody className="divide-y divide-slate-200 ">
                                <tr>
                                    ...
                                    <td className="whitespace-nowrap">
                                        <div className="px-6 py-3">
                                            <span className="text-sm md:text-base text-slate-600 ">
                                                this is a collection of panneaux pages
                                            </span>
                                        </div>
                                    </td>
                                            ...
                                            <div className="hs-dropdown relative inline-block [--placement:bottom-right]">
                                                ...
                                                <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-[10rem] z-10 bg-white shadow-2xl rounded-lg p-2 mt-2 " aria-labelledby="hs-table-dropdown-2">
                                                    <div className="py-2 first:pt-0 last:pb-0">
                                                        ...
                                                        <a className="flex items-center  font-bold gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-primary-500 " href={`/permis/${params.permisid}/panneaux/handleQuestion`}>
                                                            gerer les questions
                                                        </a>
