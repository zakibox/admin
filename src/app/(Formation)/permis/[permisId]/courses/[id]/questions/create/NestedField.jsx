            ...
            {answersFields.map((answers, i) => (
                <div className="flex gap-4 mt-4">
                    <input type="text"   {...register(
                        `data.sub_questions_list.questions.${questionIndex}.answers.${i}.text.ar`)} className="p-4 border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none 
                                                focus:pt-6
                                                focus:pb-2"
                    />

                    <input type="text"    {...register(
                        `data.sub_questions_list.questions.${questionIndex}.answers.${i}.text.fr`)} className="p-4 block border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none 
                                                focus:pt-6
                                                focus:pb-2"
