...
export default  function questionsPage({params}) {
 ...
 useEffect(() => {
    axios.get(`http://127.0.0.1:8000/api/${params.id}/panneaux/questions`)
        .then(response => {
    ...
    // }
     ...
     async function handleDelete(id) {
        try {
           ...
           await  axios.delete(`http://127.0.0.1:8000/api/permis/${params.permisId}/${params.id}/panneaux/questions/${id}`);
            // After successful deletion, you might want to update the UI by refetching the education items
            
            window.location.href = `/panneaux/${params.id}/questions`;
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between mb-4 md:mb-6 lg:mb-8">
                ...
                <Link href={`/panneaux/${params.id}/questions/create`}>
                    <button
                                ...
                                {questions.data && Object.values(questions.data).map(question => (
                                    <tr key={question.id}>
                                        ...
                                        <td className="h-px w-px whitespace-nowrap">
                                            ...
                                            <Link href={`/permis/${params.permisId}/panneaux/${params.id}/questions/${question.id}`}>
                                            ...
                                            <div className="py-2 first:pt-0 last:pb-0">
                                                           ...
                                                           <Link href={`/permis/${params.permisId}/panneaux/${params.id}/questions/${question.id}/edit`}>
                                                               <p className="flex items-center font-bold gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-primary-500" >
