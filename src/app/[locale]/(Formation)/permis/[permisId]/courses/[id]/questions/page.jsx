...
import { deleteCourseQuestion, deleteQuestion } from "@/actions/formation";
...
export default async function questionsPage({ params: { id, permisId, locale } }) {
    ...
    const t = await getTranslations('courses.questions.index')
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between mb-4 md:mb-6 lg:mb-8">
                ...
                <Link href={`/${locale}/permis/${permisId}/courses/${id}/questions/create`}>
                    <button
                                            ...
                                            <div className="px-6 py-1.5">
                                                <div className="hs-dropdown relative inline-block [--placement:bottom-right]">
                                                    ...
                                                    <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-[10rem] z-10 bg-white shadow-2xl rounded-lg p-2 mt-2">
                                                        <Link href={`/${locale}/permis/${permisId}/courses/${id}/questions/${question.id}`}>
                                                        ...
                                                        <Link href={`/${locale}/permis/${permisId}/courses/${id}/questions/${question.id}/edit`}>
                                                            <p className="flex items-center font-bold gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-primary-500" >
                                                               edit
                                                            </p>
                                                        </Link>
                                                        <div className="py-2 first:pt-0 last:pb-0">
                                                            <form action={deleteCourseQuestion}>
...
async function fetchQuestions(id) {
    const res = await axios.get(`http://127.0.0.1:8000/api/${id}/course/questions`);
    return res.data;
    // req to api
}
