...
function createPage({ params: { permisId, locale, id } }) {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            window.location.href = `/${locale}/permis/${permisId}/panneaux/${id}/questions`;
        } catch (error) {
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <label htmlFor="hs-hero-signup-form-floating-input-company-name" className="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent 
                                            ...
                                            peer-[:not(:placeholder-shown)]:text-xs
                                            peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                            peer-[:not(:placeholder-shown)]:text-gray-500">{t('explanationAr')}</label>
                                </div>
                            </div>
                            <div>
                                <div className="relative">
                                    <input type="hidden"    {...register("data.questionable_id")} defaultValue={id} id="hs-hero-signup-form-floating-input-company-name" className="  peer  w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-900 focus:ring-blue-900 disabled:opacity-50 disabled:pointer-events-none 
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                                            ...
                                            <div key={i}>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input type="text" {...register(`data.sub_questions_list.${i}.question.ar`)}
                                                        ...
                                                        className="peer p-4 mt-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none 
                                                           focus:pt-6
                                                                        focus:pb-2
                                                                        [&:not(:placeholder-shown)]:pt-6
                                                                        [&:not(:placeholder-shown)]:pb-2
