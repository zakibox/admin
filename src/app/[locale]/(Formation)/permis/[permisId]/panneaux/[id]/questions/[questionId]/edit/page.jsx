...
function editPage({ params: { questionId, permisId, locale, id } }) {
    const t = useTranslations('panneaux.questions.edit')
    const {
        control,
        register,
        handleSubmit,
        ...
        defaultValues: async () => {
            try {
                ...
                return { ...response.data, 'data.questionable_id': id, 'data.questionable_type': 'App\\Models\\Panneaux' };
